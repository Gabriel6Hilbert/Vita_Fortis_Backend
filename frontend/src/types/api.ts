...
export interface User {
  ...
  ativo: boolean;
  permissaoRelatorios?: boolean;
  saldoCashback?: number;
  aceitaComunicacoes?: boolean;
}
export const isAdmin = (user: User | null | undefined) =>
  user?.tipoUsuario === "ADMIN";
export const isCollaborator = (user: User | null | undefined) =>
...
export interface Order {
  ...
  formaRecebimento: "RETIRADA" | "ENTREGA";
  prazoEntregaDias?: number;
  formaPagamento?: string;
  referenciaPagamentoMascarada?: string;
  itens: OrderItem[];
  cupomCodigo?: string;
}
...
export interface OrderDetail extends Order {
  ...
  historicoStatus?: OrderStatusEvent[];
}
...
export interface AdminMetrics {
  ...
  comparacaoFaturamentoPercentual?: number;
  serieDiaria?: { periodo: string; faturamento: number; pedidos: number }[];
  serieMensal?: { periodo: string; faturamento: number; pedidos: number }[];
