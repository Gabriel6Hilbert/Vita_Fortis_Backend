document.addEventListener("DOMContentLoaded", function () {
    ...
    const opcoes = document.querySelectorAll(".politicasNavItens");
    const secoes = document.querySelectorAll(".politicasSection");

    function ativarSecao(alvoId) {
        /*marca link ativo*/
        opcoes.forEach(l => l.classList.remove("is-active"));
        document.querySelector(`.politicasNavItens[href="#${alvoId}"]`)?.classList.add("is-active");
    ...
    ativarSecao("secaoTroca"); /*sempre inicia na primeira seção - "fale conosco"*/
