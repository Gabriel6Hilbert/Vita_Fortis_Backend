...
public record MetricasAdminDto(BigDecimal faturamento, long pedidos, BigDecimal ticketMedio, long produtosVendidos,
 long clientes, long aguardandoRetirada, long pedidosEntrega, BigDecimal comparacaoFaturamentoPercentual, List<PontoSerieDto> serieDiaria, List<PontoSerieDto> serieMensal,
 Map<String,Long> categorias, Map<String,Long> status, List<ProdutoVendidoDto> maisVendidos, List<VendaRecenteDto> vendasRecentes, int limiteEstoqueBaixo, List<EstoqueBaixoDto> estoqueBaixo) {
 public record EstoqueBaixoDto(Long produtoId,String codigo,String nome,int quantidade,boolean ativo){}
